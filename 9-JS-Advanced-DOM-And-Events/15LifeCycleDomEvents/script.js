...
// THis event is for HTML parsed and DOM tree build
document.addEventListener('DOMContentLoaded', function (e) {
  console.log('HTML parsed and DOM tree build!', e);
});

// THis event is for Page fully loaded like CSS file and Image loaded
window.addEventListener('load', function (e) {
  console.log('Page fully loaded !', e);
});

// THis event is when we are leaving our page or we can say closing a tab.
